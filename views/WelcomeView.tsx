            ...
            <main className="relative z-10 flex flex-col items-center justify-between min-h-screen w-full px-6 py-12">
                ...
                <div className="flex-1 flex flex-col items-center justify-center w-full max-w-md">
                    ...
                    <div className="relative w-full aspect-square flex items-center justify-center mb-8">
                        ...
                        {/* Main Visual Image */}
                        <div className="relative w-64 h-64 rounded-full overflow-hidden bg-gradient-to-br from-primary/20 to-transparent flex items-center justify-center border border-white/20 backdrop-blur-sm">
                            <img
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <span className="material-symbols-outlined text-primary text-7xl opacity-90">biotech</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="text-center space-y-4">
                        <h1 className="text-slate-900 dark:text-white text-4xl md:text-5xl font-extrabold leading-tight tracking-tight">
